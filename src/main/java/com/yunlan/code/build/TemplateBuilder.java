...
import com.yunlan.code.swagger.*;
import com.yunlan.code.utils.JavaTypes;
import com.yunlan.code.utils.StringUtils;
    ...
    public static void builder(){
        try {
            ...
            if(databaseType.equals("MySQL")){
                ...
                //Swagger信息集合 : Model & Method
                List<SwaggerModel> swaggerModels = new ArrayList<SwaggerModel>();
                List<SwaggerPath> swaggerPathList = new ArrayList<SwaggerPath>();
