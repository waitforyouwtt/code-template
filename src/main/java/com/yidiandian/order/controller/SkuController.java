...
import com.yidiandian.order.entity.Sku;
import com.yidiandian.order.service.SkuService;
...
public class SkuController {
    ...
    public Result<List<Sku>> findList(@RequestBody(required = false) @ApiParam(name = "Sku对象",value = "传入JSON数据",required = false) Sku sku){
        ...
        return new Result<List<Sku>>(true,StatusCodeEnum.OK.getCode(),"查询成功",list);
    }
    ...
    public Result<Sku> findById(@PathVariable Integer id){
        ...
        return new Result<Sku>(true,StatusCodeEnum.OK.getCode(),"查询成功",sku);
    }
