...
import com.yidiandian.order.entity.Category;
import com.yidiandian.order.service.CategoryService;
...
public class CategoryController {
    ...
    public Result<List<Category>> findList(@RequestBody(required = false) @ApiParam(name = "Category对象",value = "传入JSON数据",required = false) Category category){
        ...
        return new Result<List<Category>>(true,StatusCodeEnum.OK.getCode(),"查询成功",list);
    }
    ...
    public Result<Category> findById(@PathVariable Integer id){
        ...
        return new Result<Category>(true,StatusCodeEnum.OK.getCode(),"查询成功",category);
    }
