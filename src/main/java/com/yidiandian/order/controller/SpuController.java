...
import com.yidiandian.order.entity.Spu;
import com.yidiandian.order.service.SpuService;
...
public class SpuController {
    ...
    public Result<List<Spu>> findList(@RequestBody(required = false) @ApiParam(name = "Spu对象",value = "传入JSON数据",required = false) Spu spu){
        ...
        return new Result<List<Spu>>(true,StatusCodeEnum.OK.getCode(),"查询成功",list);
    }
    ...
    public Result<Spu> findById(@PathVariable Integer id){
        ...
        return new Result<Spu>(true,StatusCodeEnum.OK.getCode(),"查询成功",spu);
    }
