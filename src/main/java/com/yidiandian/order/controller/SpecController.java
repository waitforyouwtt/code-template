...
import com.yidiandian.order.entity.Spec;
import com.yidiandian.order.service.SpecService;
...
public class SpecController {
    ...
    public Result<List<Spec>> findList(@RequestBody(required = false) @ApiParam(name = "Spec对象",value = "传入JSON数据",required = false) Spec spec){
        ...
        return new Result<List<Spec>>(true,StatusCodeEnum.OK.getCode(),"查询成功",list);
    }
    ...
    public Result<Spec> findById(@PathVariable Integer id){
        ...
        return new Result<Spec>(true,StatusCodeEnum.OK.getCode(),"查询成功",spec);
    }
