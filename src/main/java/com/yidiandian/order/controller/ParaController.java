...
import com.yidiandian.order.entity.Para;
import com.yidiandian.order.service.ParaService;
...
public class ParaController {
    ...
    public Result<List<Para>> findList(@RequestBody(required = false) @ApiParam(name = "Para对象",value = "传入JSON数据",required = false) Para para){
        ...
        return new Result<List<Para>>(true,StatusCodeEnum.OK.getCode(),"查询成功",list);
    }
    ...
    public Result<Para> findById(@PathVariable Integer id){
        ...
        return new Result<Para>(true,StatusCodeEnum.OK.getCode(),"查询成功",para);
    }
